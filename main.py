...
def main():
    # Created an instance of GymManager
    # this is an object that will help manage the members
    manager = GymManager()
    ...
    while True:
        ...
        if choice == '1':
            ...
            while True:
                ...
                if len(member_id) == 4 and member_id.isdigit():
                    if manager.is_id_unique(member_id):
                        break
                    else:
            ...
            while True: # Fixed: changed 'true' to 'True'
                print("\n--- Select Branch ---")
                print("1. Kileleshwa")
                print("2. Westlands")
                print("3. Parklands")
            ...
            # 5. AGE RANGE VALIDATION BASED ON MEMBER TYPE
            if sub_choice == '2' and not (16 <= age <= 25):
                print(f"Error: {first_name} {last_name} is {age}, but Students must be 16-25.")
                continue 
            elif sub_choice == '3' and age < 60:
                print(f"Error: {first_name} {last_name} is {age}, but Seniors must be 60+.")
                continue
            ...
            # 7. SAVE TO JSON
            manager.save_new_member(new_member)
        ...
        # UPDATE MEMBER
            ...
            if manager.is_id_unique(target):
            ...
            if manager.update_member(target, new_first, new_last, new_age):
        ...
        # DELETE MEMBER
            ...
            if manager.delete_member(target):
